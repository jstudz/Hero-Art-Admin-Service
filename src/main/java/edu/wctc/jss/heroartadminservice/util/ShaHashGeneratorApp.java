package edu.wctc.jss.heroartadminservice.util;
...
public class ShaHashGeneratorApp {
    ...
    public static void main(String[] args) {
        ...
        String salt = "jsstudz"; // username field in db
        String password = "Arthas3#"; // password field in db
        System.out.println(password + ": " + sha512(password,salt));

        salt = "testUser"; // username field in db
        password = "testUser"; // password field in db
        System.out.println(password + ": " + sha512(password,salt));
